                            ...
                            <tbody>
                                ...
                                foreach ($disposisi as $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url($this->uri->segment(1) . '/surat_masuk/download/' . $this->referensi->fileSuratMasuk($row->ID_SURAT_MASUK)) ?>" target="new"><button type="button" class="btn btn-outline-info btn-sm" title="View Surat">
