...
class Surat_masuk extends CI_Controller
{
    ...
    public function tampil($id = null)
    {
        ...
        $this->Log_surat_masuk_model->add_log($this->Auth_model->current_user()->USERNAME, $id, "Menampilkan surat masuk");
    ...
    public function download($file)
    {
        ...
        $this->Log_surat_masuk_model->add_log($this->Auth_model->current_user()->USERNAME, $surat->ID_SURAT_MASUK, "Download surat masuk");
    ...
    public function hapus($id = null)
    {
        ...
        $cekPakai = $this->Surat_masuk_model->cekPakai($id);
        if ($cekPakai > 0) {
            $this->session->set_flashdata('gagal', 'Data Surat Masuk Tidak bisa hapus, karena sudah di gunakan di data Disposisi');
            redirect(site_url('admin/surat_masuk'));
        } else {
