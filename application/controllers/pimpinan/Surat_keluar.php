...
class Surat_keluar extends CI_Controller
{
    ...
    {
        $this->Log_surat_keluar_model->add_log($this->Pegawai_login_model->current_user()->USERNAME, $id_surat, "Menampilkan surat keluar");
    ...
    public function draft_tampil($id_surat)
    {
        ...
        $this->Log_surat_keluar_model->add_log($this->Pegawai_login_model->current_user()->USERNAME, $id_surat, "Menampilkan draf surat keluar");
    ...
    public function draft_add()
    {
        ...
        redirect(site_url('pimpinan/surat_keluar/draft'));
    }

    public function draft_edit()
    {
        // if (!isset($id)) redirect(site_url('pimpinan/surat_keluar/draft'));
    ...
    public function release()
    {
        ...
        if ($validation->run()) {
            ...
            redirect(site_url('pimpinan/surat_keluar'));
        } else {
    ...
    public function draft_note()
    {
        ...
        if (!isset($id)) redirect(site_url('pimpinan/surat_keluar'));
        $this->Surat_keluar_model->save_note();
        redirect('pimpinan/surat_keluar/draft_tampil/' . $id);
    }
    ...
    public function aproved()
    {
        ...
        redirect(site_url('pimpinan/surat_keluar/draft_tampil/' . $id_surat_ttd)); //redirect ke halaman rekap tanda tangan surat usai simpan data
    }
    ...
    public function download($file)
    {
        ...
        $this->Log_surat_keluar_model->add_log($this->Pegawai_login_model->current_user()->USERNAME, $surat->ID_SURAT_KELUAR, "Download surat keluar");
    ...
    public function export()
    {
        ...
        $sheet->setCellValue('A1', "REKAP SURAT KELUAR"); // Set kolom A1 dengan tulisan "DATA SISWA"
