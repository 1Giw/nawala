...
class Pegawai_login_model extends CI_Model
{
    ...
    public function current_user()
    {
        ...
        // Ensure that column names are enclosed in double quotes for PostgreSQL
    ...
    public function getPimpinan()
    {
        ...
        // In PostgreSQL, all selected columns must be either in GROUP BY or wrapped in an aggregate function.
        // So, ensure all selected fields are included in GROUP BY if you're not using aggregate functions.
        $this->db->group_by('t_pegawai_login."ID_LOGIN", t_pegawai_login."ID_PEGAWAI", t_pegawai."NM_PEGAWAI", t_pegawai_login."USERNAME", t_pegawai_login."PASSWORD", t_pegawai_login."AKTIF", t_pegawai_login."LAST_LOGIN"');
    ...
    public function getPegawai()
    {
        ...
        // Ensure all selected fields are included in GROUP BY
        $this->db->group_by('t_pegawai_login."ID_LOGIN", t_pegawai_login."ID_PEGAWAI", t_pegawai_login."ID_BAGIAN", t_pegawai."NM_PEGAWAI", t_pegawai_login."USERNAME", t_pegawai_login."PASSWORD", t_pegawai_login."AKTIF", t_pegawai_login."LAST_LOGIN"');
